 ...
 * @author allan
 */
@WebServlet(name = "ServletManterCategorias", urlPatterns = {"/ServletManterCategorias"})
public class ServletManterCategorias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        rd = request.getRequestDispatcher("/Restrito/Admin/ManterCategorias.jsp");
